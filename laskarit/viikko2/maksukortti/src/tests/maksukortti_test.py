...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negaativinen_lataus_ei_muuta_arvoa(self):
        self.kortti.lataa_rahaa(-3)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_voi_syoda_edullisesti_minimirahalla(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_voi_syoda_maukkaasti_minimirahalla(self):
        self.kortti2 = Maksukortti(4)
        self.kortti2.syo_maukkaasti()
        #self.assertEqual(str(self.kortti), "Kortilla on rahaa 0 euroa")
        self.assertEqual(self.kortti2.arvo, 0)